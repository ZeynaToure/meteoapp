...
function App() {
  ...
  useEffect(() => { 
    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${searchCity}&appid=b7e5febaa11176f52a4898bb863a84f6&units=metric`)
      .then(result => result.json())
      .then(jsonresult => {
        setTemp(jsonresult.main.temp);
        setDesc(jsonresult.weather[0].main);
  ...
  return (
    <div className="container mt-5">
      <div className="bg-dark text-white">
        <h1 className="text-center mb-4">My weatherapp</h1>
      </div>
